...
setup(name='labop',
      ...
      packages=['labop', 'labop_convert', 'labop_convert.autoprotocol', 'labop_convert.markdown', 'labop_convert.opentrons', 'labop.lib', 'labop.utils', 'labop_time', 'uml', 'examples', 'owl_rdf_utils'],
