...
def generate_protocol(doc: sbol3.Document, activity: labop.Protocol) -> labop.Protocol:
    ...
    test_device1 = sbol3.Component(
        "test_device1", "http://parts.igem.org/Part:BBa_J428112"
    )
    ...
    test_device2 = sbol3.Component(
        "test_device2", "http://parts.igem.org/Part:BBa_J428110"
    )
    ...
    test_device3 = sbol3.Component(
        "test_device3", "http://parts.igem.org/Part:BBa_J428111"
    )
    ...
    test_device4 = sbol3.Component(
        "test_device4", "http://parts.igem.org/Part:BBa_J428101"
    )
    ...
    test_device5 = sbol3.Component(
        "test_device5", "http://parts.igem.org/Part:BBa_J428108"
    )
    ...
    test_device6 = sbol3.Component(
        "test_device6", "http://parts.igem.org/Part:BBa_J428106"
    )
...
if __name__ == "__main__":
    harness = labop.execution.harness.ProtocolHarness(
        ...
        clean_output=True,
        base_dir=os.path.join(os.path.dirname(__file__), "out", "out_igem_example1"),
