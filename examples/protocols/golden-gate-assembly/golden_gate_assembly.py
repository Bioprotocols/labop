...
def generate_protocol(
    doc: sbol3.Document, protocol: labop.Protocol
) -> labop.Protocol:
    ...
    gg_buf = sbol3.Component(
        "NEB_GoldenGate_Buffer", tyto.SBO.functional_entity
    )
    ...
    gg_mix = sbol3.Component(
        "NEB_GoldenGate_AssemblyMix", tyto.SBO.functional_entity
    )
    ...
    build_wells = protocol.primitive_step(
    ...
    protocol.primitive_step(
        "Unseal", location=build_wells.output_pin("samples")
    )
    ...
    protocol.primitive_step(
        ...
        temperature=sbol3.Measure(
            37, tyto.OM.get_uri_by_term("degree Celsius")
        ),
    ...
    protocol.primitive_step(
        ...
        temperature=sbol3.Measure(
            60, tyto.OM.get_uri_by_term("degree Celsius")
        ),
    )  # TODO: replace after resolution of https://github.com/SynBioDex/tyto/issues/29
