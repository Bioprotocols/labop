...
copy('dataModel.tex', '../PAML-specification/umlDataModel.tex')
os.remove('dataModel.tex')
#copy('uml_classes/uml.tex', '../PAML-specification/umlDataModel.tex')
os.remove('uml_classes/uml.tex')
...
copy('dataModel.tex', '../PAML-specification/dataModel.tex')
os.remove('dataModel.tex')
#copy('paml_classes/paml.tex', '../PAML-specification/dataModel.tex')
os.remove('paml_classes/paml.tex')
