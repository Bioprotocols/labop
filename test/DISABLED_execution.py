...
class TestProtocolExecution(unittest.TestCase):
    def _compare_execution_line(self, line):
        ...
        """
        return (
            "http://www.w3.org/ns/prov#startedAtTime" not in line
            and "http://www.w3.org/ns/prov#endedAtTime" not in line
        )
    ...
    def _compare_execution_files(self, fn1, fn2):
        with open(fn1, "r") as f1, open(fn2, "r") as f2:
            ...
            l.error(
                f"Executions in files: {fn1} and {fn2} have the following mismatches: \n{mismatches}"
            )
