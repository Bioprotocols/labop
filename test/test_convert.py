...
class TestConvert(unittest.TestCase):
    ...
    @unittest.skip(reason="need to put strateos_secrets.json credentials on github first")
    def test_igem_ludox_autoprotocol(self):
        #############################################
        # Set up the document
    ...
    def test_igem_ludox_opentrons(self):
        ...
        opentrons_output = os.path.join(tempfile.gettempdir(), 'igem_ludox_opentrons.json')
        ...
        assert filecmp.cmp(opentrons_output, opentrons_comparison_file), "Markdown files are not identical"
        print('File identical with test file')
